...
public class SearchRouteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabText1.setGravity(Gravity.CENTER);
        tabLayout.getTabAt(1).setCustomView(tabText1);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_search_express, container, false);
            return rootView;
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        private Fragment expressFragment=new SearchExpressFragment();
        private Fragment intercityFragment=new SearchIntercityFragment();
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0: return expressFragment;
                case 1: return intercityFragment;
                default: return expressFragment;
            }
        }
